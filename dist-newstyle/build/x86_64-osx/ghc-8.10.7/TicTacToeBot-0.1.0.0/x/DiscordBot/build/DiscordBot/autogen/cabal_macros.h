...
/* package TicTacToeBot-0.1.0.0 */
#ifndef VERSION_TicTacToeBot
#define VERSION_TicTacToeBot "0.1.0.0"
#endif /* VERSION_TicTacToeBot */
#ifndef MIN_VERSION_TicTacToeBot
#define MIN_VERSION_TicTacToeBot(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "TicTacToeBot-0.1.0.0-inplace-DiscordBot"
